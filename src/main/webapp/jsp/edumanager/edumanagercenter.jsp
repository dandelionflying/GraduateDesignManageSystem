...
<link rel="icon" type="image/png"
	href="${pageContext.request.contextPath}/resource/i/favicon.png">
...
<body data-type="index">
	...
	<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
		...
		<ul
				...
				<ul class="am-dropdown-content tpl-dropdown-content">
					...
					<li><a href="#" class="tpl-dropdown-content-message"> <span
							class="tpl-dropdown-content-photo"> <img
								src="resource/img/user02.png" alt="">
							...
							class="tpl-dropdown-content-photo"> <img
								src="resource/img/user03.png" alt="">
						</span> <span class="tpl-dropdown-content-subject"> <span
			...
			<li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
				<a class="am-dropdown-toggle tpl-header-list-link"
				href="javascript:;"> <span class="tpl-header-list-user-nick">dandelion</span><span
					class="tpl-header-list-user-ico"> <img
						src="${pageContext.request.contextPath}/resource/img/user01.png"></span>
			</a>
				...
				<ul class="tpl-left-nav-menu">
					...
					<li class="tpl-left-nav-item"><a href="javascript:;"
						class="nav-link tpl-left-nav-link-list"> <i
							class="am-icon-table"></i> <span>课题管理</span> <i
							class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right"></i>
					</a>
						<ul class="tpl-left-nav-sub-menu">
							<li><a href="topiclist1"> <i class="am-icon-angle-right"></i>
									<span>待审核</span>
							</a> <a href="topiclist2"> <i class="am-icon-angle-right"></i> <span>已通过</span>
							</a> <a
								href="${pageContext.request.contextPath}/jsp/edumanager/stdetails.jsp">
									<i class="am-icon-angle-right"></i> <span>未通过</span>
							</a> <a
								href="${pageContext.request.contextPath}/jsp/edumanager/stdetails.jsp">
									<i class="am-icon-angle-right"></i> <span>选题详情</span>
							</a></li>
						</ul></li>
					...
					<li class="tpl-left-nav-item"><a href="javascript:;"
						...
						<ul class="tpl-left-nav-sub-menu">
							<li><a href="teacherManager"> <i
									class="am-icon-angle-right"></i> <span>教师管理</span>
							</a> <a href="studentManager"> <i class="am-icon-angle-right"></i>
									<span>学生管理</span>
							</a></li>
						</ul></li>
		...
		<div class="tpl-content-wrapper">
			...
			<div class="tpl-content-scope gdms-state">
				<div class="note note-info">
					<h3>
						选题状态 <span class="close" data-close="note"></span>
					</h3>
					<div class="am-g">
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-success"><span class="am-icon-pencil-square-o"></span> 修改</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
					...
					<div class="tpl-portlet">
						...
						<div class="tpl-scrollable">
							...
							<table class="am-table tpl-table">
								...
								<tbody>
									<tr>
										<td><img src="resource/img/user01.png" alt=""
									...
									<tr>
										<td><img src="resource/img/user02.png" alt=""
									...
									<tr>
										<td><img src="resource/img/user03.png" alt=""
									...
									<tr>
										<td><img src="resource/img/user04.png" alt=""
									...
									<tr>
										<td><img src="resource/img/user05.png" alt=""
									...
									<tr>
										<td><img src="resource/img/user06.png" alt=""
