...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/manager-studentdocs.js"></script>
</head>
					...
					<li class="tpl-left-nav-item">
						...
						<ul class="tpl-left-nav-sub-menu" style="display: block">
							<li>
								...
								<a class="active" href="file-student">
                ...
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="am-u-sm-12 am-u-md-6">
                            <!-- <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-round am-btn-danger"><span class="am-icon-remove"></span> 待定</button>
                                </div>
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-round am-btn-primary"><span class="am-icon-plus"></span> 待定</button>
                                </div>
                            </div> -->
                        </div>
                        ...
                        <div class="am-u-sm-12 am-u-md-3">
                            <!-- <div class="am-input-group am-input-group-sm">
                                <input type="text" id="key" class="am-form-field" placeholder="根据学号搜索">
                                <span class="am-input-group-btn">
            						<button class="am-btn am-btn-default am-btn-success tpl-am-btn-success am-icon-search" id="student-doc-search" type="button"></button>
          						</span>
                            </div> -->
                        </div>
                    </div>
                    	...
                    	<li>
                           <!--  <div class="task-checkbox">
                            ...
                            <div class="am-g task-title">
                                <span class="am-u-sm-5 task-title-sp"> 开题报告 </span>
                                <span class="am-u-sm-2">类型</span>
                                <span class="am-u-sm-2">14154803018</span>
                                <span class="am-u-sm-2">时间</span>
                            </div>
                            <div class="task-config">
                                <div class="am-dropdown tpl-task-list-dropdown" data-am-dropdown="">
                                    ...
                                    <ul class="am-dropdown-content tpl-task-list-dropdown-ul">
                                        <li><a href="javascript:;"><i class="am-icon-check"></i> 查看 </a></li>
                                        <li><a href="javascript:;"><i class="am-icon-trash-o"></i> 删除 </a></li>
                                    </ul>
                                </div>
                            </div> -->
                        </li>
                    ...
                    <div class="am-g">
                        <div class="am-u-sm-12">
                            ...
                            <div class="am-cf">
                                <div class="am-fr">
                                	<ul class="am-pagination tpl-pagination" id="student-docs-page">
