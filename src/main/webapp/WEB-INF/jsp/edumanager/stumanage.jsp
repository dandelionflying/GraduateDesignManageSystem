...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/manager-student.js"></script>
...
<body data-type="generalComponents">
    ...
    <div class="tpl-page-container tpl-page-header-fixed">
					...
					<li class="tpl-left-nav-item">
						...
						<ul class="tpl-left-nav-sub-menu" style="display: block">
							<li>
								...
								<a class="active" href="studentManage">
        ...
        <div class="tpl-content-wrapper">
            ...
            <div class="tpl-portlet-components">
                ...
                <div class="tpl-block">
                    <div class="am-g import">
                    	<div class="am-u-sm-12">
                        	<button class="am-btn am-btn-primary am-round" id="add-student-btn">从excel文件导入</button>
                    	</div>
                    </div>
                    <div class="am-g">
                        <div class="am-u-sm-12">
							...
							<table class="am-table am-table-striped am-table-radius am-table-hover table-main">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="table-year">入学年份</th>
                                        <th class="table-class">班级</th>
	...
	<div class="am-modal am-modal-no-btn" tabindex="-1" id="add-student-modal">
		<div class="am-modal-dialog">
			<div class="am-modal-hd" id="topic-title">
				从Excel导入学生信息 <a href="javascript: void(0)"
