...
<body data-type="generalComponents">
					...
					<li class="tpl-left-nav-item">
						...
						<ul class="tpl-left-nav-sub-menu" style="display: block">
							<li>
								...
								<a class="active" href="topiclist2">
                        ...
                        <div class="am-u-sm-12">
                            <form class="am-form">
                                <table class="am-table am-table-striped am-table-radius am-table-hover table-main">
                                    ...
                                    <tbody class="passed-topic-tbody">
                                ...
                                <div class="am-cf">
                                    ...
                                    <div class="am-fr">
                                        <ul class="am-pagination tpl-pagination" id="passed-ul">
	...
	<div class="am-modal am-modal-no-btn" tabindex="-1" id="detail-modal-2">
	...
	<script src="${pageContext.request.contextPath}/js/manager-list2.js"></script>
</body>
