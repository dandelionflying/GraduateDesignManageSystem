...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/manager-grade.js"></script>
                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        <div class="am-u-sm-12 am-u-md-12">
							<table class="am-table am-table-striped am-table-radius am-table-bd table-main">
								<thead>
									<tr>
										<td>学号</td>
										<td>姓名</td>
