		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				...
				<ul class="nav navbar-nav" style="float:right">
					<li><a href=" "><span class="glyphicon glyphicon-home"></span> 通知</a></li>
					<li><a href=" "><span class="glyphicon glyphicon-list"></span> 退出</a></li>
				</ul>
			</div>
			...
			<div class="row">
				<c:forEach items="${myStudents}" var="student">
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="main-box stu-wheat3" onclick='getStudentTopic(${student.id})' >
